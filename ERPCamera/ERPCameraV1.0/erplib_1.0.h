...
//RotatedSensor generates a grid/sensor located in the Z=1 plane and center at the (X,Y) = (0,0) and rotates the sensor over the angles phi0(azimuth), theta0(inclination).
